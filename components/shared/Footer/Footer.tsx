                ...
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        <div className="text-4xl font-black text-ophthall-blue mb-6 tracking-tighter">
                            <Image className='w-[130px] h-auto sm:w-[150px] md:w-[160px] lg:w-40   xl:w-[160px] object-contain' src="/assets/OphthallMart_logo.PNG" width={170} height={170} alt="" />
                    </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <a href="tel:+91 8754517944" className="text-ophthall-blue hover:text-ophthall-orange transition-colors font-semibold">
                                +91 87545 17944
                            </a>
                        </div>
                        <div>
                            <p className="text-sm text-gray-600 mb-1">OIS Enquiries:</p>
                            <a href="tel:+919176709051" className="text-ophthall-blue hover:text-ophthall-orange transition-colors font-semibold">
